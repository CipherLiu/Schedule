...
import com.example.schedule.R.style;
...
public class RecordButton extends ImageButton {
	...
	private void finishRecord() {
		...
		if (intervalTime < MIN_INTERVAL_TIME) {
			Toast.makeText(getContext(), R.string.short_time, Toast.LENGTH_SHORT).show();
	...
	private void cancelRecord() {
		...
		Toast.makeText(getContext(), R.string.cancal_record, Toast.LENGTH_SHORT).show();
		File file = new File(mFileName);
		file.delete();
	}
