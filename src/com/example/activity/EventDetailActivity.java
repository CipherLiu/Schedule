...
import com.example.net.AsyncImageLoader;
import com.example.schedule.R;
import com.example.ui.DrawView;
...
public class EventDetailActivity extends Activity implements  OnTouchListener, OnGestureListener{
	...
	AsyncImageLoader syncImageLoader; 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		profile[0].setOnClickListener(new View.OnClickListener() {
             ...
             public void onClick(View v) {
            	 ...
            	 toDateActivity(currentCal,memberId.get(sixTupleIndex*6));
     			 //Modified by liu
             }
		});
		profile[1].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
            	...
            	toDateActivity(currentCal,memberId.get(sixTupleIndex*6+1));
            	//Modified by liu
            }
		});
		profile[2].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
            	...
            	toDateActivity(currentCal,memberId.get(sixTupleIndex*6+2));
            	//Modified by liu
            }
		});
		profile[3].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
            	...
            	toDateActivity(currentCal,memberId.get(sixTupleIndex*6+3));
            	//Modified by liu
            }
		});
		profile[4].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
            	...
            	toDateActivity(currentCal,memberId.get(sixTupleIndex*6+4));
            	//Modified by liu
            }
		});
		profile[5].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
            	...
            	toDateActivity(currentCal,memberId.get(sixTupleIndex*6+5));
            	//Modified by liu
            }
		});
		/*
...
//		System.out.println("JSON data:"+jsonStringFromFragment);
	...
	//added by liu
	private void toDateActivity(Calendar calSelected,String userId){
...
//				System.out.println("sixTupleIndex in to right gesture:"+sixTupleIndex);
		...
		if  (e1.getY()-e2.getY() > FLING_MIN_DISTANCE 
			...
			requestCal.setTimeInMillis(currentCal.getTimeInMillis());
			requestCal.add(Calendar.DAY_OF_YEAR, dayOffset);
		...
		protected void onPostExecute(JSONObject result) {
			...
			try {
				...
				case Primitive.ACCEPT:
					...
					Intent i = new Intent(EventDetailActivity.this,DateActivity.class);
					Calendar calTemp = Calendar.getInstance();
					calTemp.setTimeInMillis(currentCal.getTimeInMillis());
					calTemp.set(Calendar.HOUR_OF_DAY, 
							Calendar.getInstance().get(Calendar.HOUR_OF_DAY));
					calTemp.set(Calendar.MINUTE, 
							Calendar.getInstance().get(Calendar.MINUTE));
					i.putExtra("calendar", calTemp.getTimeInMillis());
					i.putExtra("userId", userId);
					i.putExtra("publisherId", publisherId);
					i.putExtra("eventArray", jArray.toString());
					i.putExtra("groupListString", "[]");
					i.putExtra("fromActivity", "EventDetailActivity");
					EventDetailActivity.this.startActivityForResult(i,2);
					break;
				case Primitive.DBCONNECTIONERROR:
					Toast DBError = Toast.makeText(EventDetailActivity.this,
