...
import com.example.activity.NewEventActivity.OneDayEventQueryAT;
import com.example.activity.NewEventActivity.eventCheckAT;
import com.example.activity.RegisterActivity.RegisterAT;
import com.example.net.Global;
import com.example.net.Primitive;
import com.example.net.AsyncImageLoader;
import com.example.schedule.R;
import com.example.schedule.R.drawable;
import com.example.schedule.R.id;
import com.example.schedule.R.layout;
import com.example.schedule.R.menu;
import com.example.typeinfo.UserInfo;
...
public class NewGroupActivity extends Activity {
    ...
    public class GroupItemAdapter extends BaseAdapter {  
        ...
        public GroupItemAdapter(Context context, ListView listView) {  
            ...
            syncImageLoader = new AsyncImageLoader();  
            mListView = listView;  
        }  
        ...
        AsyncImageLoader.OnImageLoadListener imageLoadListener = 
        		new AsyncImageLoader.OnImageLoadListener() {  
